  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        lg:w-96 p-8 pt-9 m-3 banner bg-hero-pattern bg-no-repeat
        bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Earnings</p>
              <p className='text-2xl text-gray-200'>49,345,98 EGP</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
        ...
        <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
          {earningData.map((item) => (
            ...
            dark:bg-secondary-dark-bg md:2-56 p-4 pt-9
            rounded-2xl'>
              <button type='button'
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>60,000 EGP</span>
                  <span
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>20,000 EGP</span>
